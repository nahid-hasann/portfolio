            ...
            <div className="container mx-auto px-6 grid md:grid-cols-2 gap-10 items-center relative z-10">
                ...
                >
                    ...
                    >
                        ...
                        <img
                            src="/public/193213-.jpg"
                            alt="Nahid Profile"
                            className="w-full object-bottom h-full object-cover rounded-full shadow-2xl border-4 border-black grayscale hover:grayscale-0 transition duration-500"
                        />
                    </motion.div>
                </motion.div>
            </div>
