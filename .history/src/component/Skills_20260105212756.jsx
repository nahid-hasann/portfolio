    ...
    const skillCategories = [
        ...
        },
        {
            ...
            skills: [
                ...
                { name: "VS Code", icon: <FaCode className="text-blue-400" />, level: 95 }, // FaCode import করতে হবে যদি আলাদা আইকন চাও, অথবা ডিফল্ট রাখো
            ]
        }
    ];

    // আইকন এর জন্য FaCode ইমপোর্ট লিস্টে যোগ করে নাও যদি এরর দেয়, অথবা নিচের কোডে আমি ফিক্স করে দিচ্ছি।
    // *নোট: FaCode উপরে ইমপোর্ট করা নেই, তাই Tools এর জন্য আমরা জেনেরিক আইকন ব্যবহার করতে পারি বা উপরে ইমপোর্ট করতে পারি।
    // আমি নিচে ইমপোর্ট ফিক্স করে দিচ্ছি।
