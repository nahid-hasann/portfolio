...
import { FaCode, FaPaintBrush, Fagamepad, FaCoffee } from "react-icons/fa"; // কিছু আইকন শখের জন্য
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        {/* Card 3: Hobbies (Gaming/Sports) */}
                        <div className="p-6 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition duration-300">
                            <FaCoffee className="text-3xl text-gray-300 mb-4" />
                            <h4 className="text-xl font-bold mb-2">Coffee & Code</h4>
                            <p className="text-gray-500 text-sm">I love coding with a fresh cup of coffee.</p>
                        </div>
                        {/* Card 4: Interests */}
                        <div className="p-6 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition duration-300">
                            {/* এখানে তুমি তোমার পছন্দের আইকন দিতে পারো */}
                            <h4 className="text-xl font-bold mb-2">Motorcycles</h4>
                            <p className="text-gray-500 text-sm">Exploring new places and bike maintenance.</p>
                        </div>
