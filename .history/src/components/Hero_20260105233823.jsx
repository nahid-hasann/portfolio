            ...
            <div className="container mx-auto px-6 grid md:grid-cols-2 gap-10 items-center relative z-10">
                ...
                >
                    ...
                    <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                        ...
                        {/* ২. এখানে HashLink ব্যবহার করা হলো যাতে পেজ রিফ্রেশ না হয় */}
                        <HashLink
                            smooth
                            to="/#contact"
                ...
                >
                    {/* ৩. ছবির সাইজ w-80 থেকে w-full max-w-[300px] করা হলো */}
                    <motion.div
                        animate={{ y: [0, -20, 0] }}
                        transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
                        className="relative w-full max-w-[300px] aspect-square md:w-96 md:h-96 mx-auto"
                    >
                        ...
                        <img
                            src="/193213-.jpg"
                            alt="Nahid Profile"
                            className="w-full object-top h-full object-cover rounded-full shadow-2xl border-4 border-black grayscale hover:grayscale-0 transition duration-500"
                        />
                    </motion.div>
                </motion.div>
            </div>
