                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <p className="text-gray-400 leading-relaxed">
                            Currently, I am focused on building scalable web apps using <span className="text-white font-bold">Next.js</span>.
                            My goal is to write clean code and deliver excellent user experiences in every project I build.
                        </p>
                    </motion.div>
