...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
            .sendForm(
                'service_c7t9zce',    // তোমার Service ID
                'template_ezqecbf',   // তোমার Template ID
                form.current,
                {
                    publicKey: 'oFAv14p82SjuN4ari', // তোমার Public Key (API)
                }
            )
            .then(
                () => {
                    ...
                    e.target.reset(); // সফল হলে ফর্ম ক্লিয়ার হবে
                },
                (error) => {
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-lg font-semibold">+880 1314142586</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-lg font-semibold">mhnahid1w3r@gmail.com</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <a
                                        href="https://wa.me/8801314142586"
                                        target="_blank"
                        ...
                        <form ref={form} onSubmit={sendEmail} className="space-y-6">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full bg-black/50 border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-white/50 transition"
                                />
                            </div>
                            <div>
                            ...
                            <button type="submit" className="w-full bg-white text-black font-bold py-3 rounded-lg hover:bg-gray-200 transition duration-300">
                                Send Message
                            </button>
                        </form>
                    </motion.div>
