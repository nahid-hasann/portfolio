...
const Navbar = () => {
    ...
    // 🔥 নতুন: এই ফাংশনটি ন্যাপবারের উচ্চতা অনুযায়ী একটু উপরে থামাবে
    const scrollWithOffset = (el) => {
        const yCoordinate = el.getBoundingClientRect().top + window.scrollY;
        const yOffset = -80; // ন্যাপবারের হাইট অনুযায়ী অ্যাডজাস্টমেন্ট
            ...
            <div className="container mx-auto px-6 py-4 flex justify-between items-center">
                ...
                >
                    <HashLink
                        smooth
                        to="/#home"
                        scroll={el => scrollWithOffset(el)} // অফসেট যোগ করা হলো
                    ...
                    {navLinks.map((link, index) => (
                        ...
                        >
                            <HashLink
                                smooth
                                to={link.path}
                                scroll={el => scrollWithOffset(el)} // 🔥 এখানেও অফসেট যোগ করা হলো
                        ...
                        <div className="flex flex-col items-center py-6 space-y-4">
                            {navLinks.map((link) => (
                                <HashLink
                                    ...
                                    smooth
                                    to={link.path}
                                    scroll={el => scrollWithOffset(el)} // 🔥 মোবাইলেও অফসেট যোগ করা হলো
